...
//   ukit-css build [--config path] [--content glob...] [--output file] [--minify]
//   ukit-css watch [--config path] [--content glob...] [--output file] [--minify]
//
...
${kleur.bold("Usage")}
  ukit-css build [options]
  ukit-css watch [options]
...
${kleur.bold("Examples")}
  ukit-css build -o dist/app.css
  ukit-css build --content "src/**/*.{html,tsx,vue}" -o dist/app.css --minify
  ukit-css watch -o dist/app.css
`)
}
